...
contract Payroll is Ownable {
    ...
    function addEmployee(address employeeId, uint _salary) public onlyOwner employeeNotExist(employeeId) {
    ...
    function updateSalary(address employeeId, uint salary) public onlyOwner employeeExist(employeeId) {
        var employee   = employees[employeeId];
    ...
    function changePaymentAddress(address employeeNewId) public employeeExist(msg.sender) employeeNotExist(employeeNewId) {
