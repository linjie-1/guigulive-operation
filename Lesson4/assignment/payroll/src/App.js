        ...
        <main className="container">
          <div className="pure-g">
            <div className="pure-u-1-1">
              <h1>Good to Go!</h1>
              <p>NO° 103</p>
              <h2>Payroll Smart Contract</h2>
              <p>If your contracts compiled and migrated successfully, below will show some good stuff.</p>
              <p>Try changing the value stored on <strong>line 59</strong> of App.js.</p>
              <p>The good stuff is: {this.state.storageValue}</p>
            </div>
          </div>
        </main>
      </div>
