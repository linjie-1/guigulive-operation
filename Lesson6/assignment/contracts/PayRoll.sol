...
contract PayRoll is Ownable {
    ...
    //define some event to update UI on web page
    event NewEmployeeEvent(address employeeId);
    event UpdateEmployeeEvent(address employeeId);
    event RemoveEmployeeEvent(address employeeId);
    event NewFundEvent(uint balance);
    event GetPaidEvent(address employeeId);
    ...
    function removeEmployee(address employeeId) onlyOwner employeeExist(employeeId){
        ...
        RemoveEmployeeEvent(employeeId);
    ...
    function updateEmployee(address employeeId, uint salary) onlyOwner employeeExist(employeeId){
       ...
       employee.lastPayDay=now;
        ...
        UpdateEmployeeEvent(employeeId);
    }
