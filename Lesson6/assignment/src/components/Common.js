...
class Common extends Component {
  ...
  componentDidMount() {
    ...
    this.newFund = payroll.NewFund(this.updateInfo);
    this.getPaid = payroll.GetPaid(this.updateInfo);
    this.newEmployee = payroll.NewEmployee(this.updateInfo);
    this.updateEmployee = payroll.UpdateEmployee(this.updateInfo);
    this.removeEmployee = payroll.RemoveEmployee(this.updateInfo);
